...
public class Tabuleiro extends JPanel {
    ...
    // Retorna referencia do elemento em determinada posição
    ...
    // public void addElemento(ElementoBasico elemento, int linha, int coluna) {
    // celulas[linha][coluna] = elemento;
    // }
